...
Бэкэнд, вдохновлённый Danbooru, для Android‑клиента без зависимостей от GMS.
...
- Пользователи и роли: **MEMBER / JANITOR / MODERATOR / ADMIN**  
- Первая зарегистрированная учётная запись автоматически получает роль **ADMIN** (для начального bootstrap)  
- Загрузка файлов или по URL‑источнику  
- Посты, теги, алиасы, импликации, избранное, голосования  
- Комментарии  
- Пулы  
- Страницы Wiki + история версий  
- Артисты  
- Очередь модерации, флаги, апелляции  
- Хостинг статических медиа (оригиналы/превью)  
